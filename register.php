    ...
    <div class="login">
      ...
      <form method="post" action="?act=register">
        ...
        <p><input type='number' name='phone' size='30' placeholder='Contact Number'></p>
         <p><input type='date' name='dob' size='30' placeholder='Date Of Birth'></p>
...
{
$insertProfile = mysql_query("INSERT INTO profile_pic (username) VALUES ('$username')");
