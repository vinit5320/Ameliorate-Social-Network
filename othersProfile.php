...
$usrname= $p;
$rsdob = mysql_query("SELECT name FROM jaiho_user WHERE username = '$p'");
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well">
          ...
          <center> <?php
          include("connect.php");
          $q=mysql_query("SELECT * FROM profile_pic WHERE username like '$p'");
      ...
      <div class="col-md-3"><div class="well">
        SORTER
        <br><br><h3><form method="POST" action="othersProfile.php?username=<?php echo $p; ?>"><input type='text' name="type" hidden value="Deeds"><button type='submit' class='btn btn-info feed-action-button2'>All</button></form></h3>
        <br><br><h3><form method="POST" action="othersProfile.php?username=<?php echo $p; ?>"><input type='text' name="type" hidden value="Action"><button width='200px' type='submit' class='btn btn-warning feed-action-button2'>Call For Action</button></form></h3>
        <br><br><h3><form method="POST" action="othersProfile.php?username=<?php echo $p; ?>"><input type='text' name="type" hidden value="Concern"><button type='submit'class='btn btn-success feed-action-button2' >Raise A Concern</button></form></h3>
        <br><br>
      </div></div>
      ...
      while($row = mysql_fetch_array($result))
      {
        ...
        echo" <button type='button' style='position:absolute;right:7%;bottom:0%;' class='btn btn-primary feed-action-button' onclick='newfun()'>Share</button>";
        ...
        echo"   <button type='submit'style='position:absolute;right:-5%;bottom:0%' class='btn btn-success feed-action-button'>Im in</button>";
        echo"</form>";
